...
from lib.models.all_models import InspectionModel
...
display_config = {
    ...
    'key_fields': ['inspection_type', 'inspection_date', 'inspector', 'result', 'status'] if 'status' in model.schema.get('fields', {}) else ['id'],
