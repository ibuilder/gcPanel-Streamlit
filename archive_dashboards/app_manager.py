...
def render_selected_module(current_menu):
    ...
    module_mapping = {
        ...
        "Documents": render_documents,
        "🏗️ Subcontractor Management": modules.subcontractor_management.render,
        "Subcontractor Management": modules.subcontractor_management.render,
        "📸 Progress Photos": modules.progress_photos.render,
        "Progress Photos": modules.progress_photos.render,
        "🔍 Inspections": modules.inspections.render,
        "Inspections": modules.inspections.render,
        "⚠️ Issues & Risks": modules.issues_risks.render,
        "Issues & Risks": modules.issues_risks.render,
        "📊 Performance Snapshot": modules.performance_snapshot.render,
        "Performance Snapshot": modules.performance_snapshot.render,
        "💼 Companies Database": render_companies_database,
        "Companies Database": render_companies_database,
        "✅ Prequalifications": render_prequalifications,
        "Prequalifications": render_prequalifications,
        "📋 Budget Management": render_budget_management,
        "Budget Management": render_budget_management,
        "📑 Schedule of Values": render_schedule_of_values,
        "Schedule of Values": render_schedule_of_values,
        "📄 File Explorer": render_file_explorer,
        "File Explorer": render_file_explorer,
        "📈 Reports Generation": render_reports_generation,
        "Reports Generation": render_reports_generation,
        "👥 User Profiles": render_user_profiles,
        "User Profiles": render_user_profiles,
        "🔧 General Conditions": render_general_conditions,
        "General Conditions": render_general_conditions,
        "🏷️ Cost Codes": render_cost_codes,
        "Cost Codes": render_cost_codes,
